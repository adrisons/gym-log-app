 ...
 * hamburger button that opens a dropdown listing the three destinations
 * the project owner asked to keep here: Diary, Insights, Exercises.
 ...
 * from Insights cards), it just isn't one of this menu's three items, now
